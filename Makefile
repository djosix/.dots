...
vim:
	...
	rm -rf ~/.vim ~/.vimrc
	echo '" Do not edit this file, add your configurations to ~/.local.vim' > ~/.vimrc
	echo 'source ~/.dots/vim/vimrc.vim' >> ~/.vimrc
	echo 'source ~/.local.vim " user configurations' >> ~/.vimrc
	cp -r vim/vim ~/.vim
	test -e ~/.local.vim || cp vim/local.vim ~/.local.vim
